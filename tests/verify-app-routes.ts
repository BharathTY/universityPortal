...
export function canonicalizeAppPathname(pathname: string): string {
  ...
  const rules: Array<[RegExp, string]> = [
    ...
    [
      /^\/dashboard\/consultant\/leads\/[^/]+\/edit$/,
      "/dashboard/consultant/leads/[:id]/edit",
    ],
...
export function verifyAppRoutes(): void {
  ...
  const staticMustExist = [
    ...
    "/dashboard/master",
    "/dashboard/master/leads",
    "/dashboard/master/seats",
    ...
    "/dashboard/consultant/leads/[:id]/edit",
    "/dashboard/consultant/assigned-universities",
    "/dashboard/consultant/spocs",
    "/dashboard/consultant/invoices",
